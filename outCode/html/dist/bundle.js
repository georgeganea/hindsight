...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function () {
	  ...
	  /*
	     * @constructs App @param {Object} options
	     */
	  ...
	  /*
	     * @method render @param {DOM} [element] @returns {String|undefined}
	     */
	  ...
	  _createClass(App, [{
	    ...
	    /*
	       * @method render @param {DOM} element
	       */
	  }, {
	    key: 'renderToDOM',
	    ...
	    /*
	       * @method renderToString @returns {String}
	       */
	  }, {
	    key: 'renderToString',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cart = (function (_React$Component) {
	    ...
	    function Cart() {
	        ...
	        if (typeof theJavaFunction === 'function') this.dbstatus = theJavaFunction("GetDBStatus");
	    }
	    ...
	    _createClass(Cart, [{
	        key: 'messageReceived',
	        value: function messageReceived(e) {
	        ...
	        value: function render() {
	            return _reactAddons2['default'].createElement(
	                ...
	                { className: 'cart' },
	                this.state.history.map(function (item, key) {
	                    return _reactAddons2['default'].createElement(_Item2['default'], { item: item });
	                })
	            );
	        }
	    }]);
	...
	var Item = (function (_React$Component) {
	  ...
	  _createClass(Item, [{
	    ...
	    value: function handleClick(event) {
	      ...
	      console.log("-->" + commits);
	      if (commits[0] && commits[1]) theJavaFunction("OpenCommitDiff", commits[0], commits[1], this.props.item.filePath);
	    }
	    ...
	    value: function render() {
	      ...
	      for (var i = 0; i < this.props.item.rels.length; i++) {
	        if (this.props.item.rels[i]) cells.push(_reactAddons2["default"].createElement("div", { className: "accesses", id: this.props.item.rels[i], onClick: this.handleClick.bind(this) }));else cells.push(_reactAddons2["default"].createElement("div", { className: "accesseswhite", id: this.props.item.rels[i], onClick: this.handleClick.bind(this) }));
	      }
